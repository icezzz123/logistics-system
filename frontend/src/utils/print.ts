...
export function joinPrintLines(lines: Array<string | null | undefined>) {
...
export function renderPrintHead(title: string, subtitle?: string, chip?: string) {
  return `
...
export function renderPrintFieldGrid(sections: Array<{ title: string; fields: Array<{ label: string; value: string }> }>) {
  return `
...
export function renderPrintTable(title: string, headers: string[], rows: string[][]) {
  return `
